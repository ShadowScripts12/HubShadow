...
local trueData = "925d38694a5b4f36b383a370046ee7f6"
local falseData = "6729b360b13c4449956939ae7a94f7e9"

KeyGuardLibrary.Set({
  publicToken = "9a31340757644479a4ba6bdd741d091e",
  privateToken = "d11e8adff26e4bd49c0b418331f7c46f",
  trueData = trueData,
  falseData = falseData,
})
                                ...
                                {            
                                    ...
                                    ["fields"]= {
                                        ...
                                        },
                                        {
                                            ...
                                            ["value"]= "```Người dùng đã chạy script ShadowHub Auto Farm Cảm Ơn Vì Đã Dùng RinX!!!!```",
                                            ["inline"]= true
                                            },
                                       {
                                     ["name"] = "𝙅𝙤𝙗 𝙄𝙙",
...
local Tabs = {
    Main = Window:AddTab({ Title = "Main", Icon = "rbxassetid://90083218143855" }),
    Setting = Window:AddTab({ Title = "Setting", Icon = "rbxassetid://90083218143855" }),
    Stats = Window:AddTab({ Title = "Stats", Icon = "rbxassetid://90083218143855" }),
    Player = Window:AddTab({ Title = "Player", Icon = "rbxassetid://90083218143855" }),
    Teleport = Window:AddTab({ Title = "Teleport", Icon = "rbxassetid://90083218143855" }),
    Fruit = Window:AddTab({ Title = "Fruit", Icon = "rbxassetid://90083218143855" }),
    Raid = Window:AddTab({ Title = "Raid", Icon = "rbxassetid://90083218143855" }),
    Race = Window:AddTab({ Title = "Race V4", Icon = "rbxassetid://90083218143855" }),
    Shop = Window:AddTab({ Title = "Shop", Icon = "rbxassetid://90083218143855" }),
	Misc = Window:AddTab({ Title = "Misc", Icon = "rbxassetid://90083218143855" }),
}
...
OrionLib:MakeNotification(
        {
            ...
            Image = "rbxassetid://90083218143855",
            Time = 7
        }
    )
_G.lakala = true

setclipboard("ShadowHub Is The Best")
	...
	if (getgenv().ED_AntiKick.CheckCaller and not checkcaller() or true) and stringlower(getnamecallmethod()) == "kick" and ED_AntiKick.Enabled then
		if getgenv().ED_AntiKick.SendNotifications then
			StarterGui:SetCore("SendNotification", {
				...
				Icon = "rbxassetid://90083218143855",
				Duration = 2,
			})
		end
...
Tabs.Main:AddButton({
        Title = "ShadowHub Discord Server",
...
Fluent:Notify({
    Title = "ShadowHub",
    Content = "Thanks For Using ShadowHub",
    Duration = 8
})
